...
//================ Task 1 ==============================
        ...
        // rollDice = document.querySelector("#play-game")
        // rollDice = document.querySelector("#reset")
       
        // function rollDice(myDice, pcDice){
        //     const player = [1,2,3,4,5,6]
        // const evilPC = [1,2,3,4,5,6]
        // const randPlayer = player[Math.floor(math.random() * 6)]
        
        // const randPc = randPc[Math.floor(math.random()*6)]
            
        //     return (randPlayer > randPc ? "PLAYER WINS" : "COMPUTER WINS" || randPc > randPlayer "COMPUTER WINS" : PLAYER WINS)
        // }
        // console.log(rollDice(randPlayer(true)))
        
        // console.log(rollDice(randPc(false)))
